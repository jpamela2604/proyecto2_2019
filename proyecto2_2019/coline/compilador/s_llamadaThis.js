...
class s_llamadaThis{
    ...
    getTree()
    {
        ...
        vari.hash++;
        var myid=new nodoArbol("this",vari.hash);
    ...
    comprobacion(ts,er)
    {
        ...
        if(ts.metodoActual==null||!(ts.metodoActual.rol==tablaTipos.rol_constructor))
        {
            er.addError("La llamada al this debe estar dentro de un constructor",this.linea,this.columna,this.archivo,
                "SEMANTICO");
            return respuesta;
        }
        ...
        this.iden=new identificador(ts.claseActual.nombre,misparams);
