...
class traducir{
    ...
    getSizeArray()
    {
        ...
        var t13=valores.getTemporal();var t14=valores.getTemporal();
        var t15=valores.getTemporal();var t16=valores.getTemporal();
        var t17=valores.getTemporal();
        var l1=valores.getEtiqueta();var l2=valores.getEtiqueta();
        var l3=valores.getEtiqueta();var l0=valores.getEtiqueta();
        this.save("void getSize(){\n");
        this.save("        "+t1+"=p+1;\n");
        this.save("        "+t2+"=stack["+t1+"];\n");
        this.save("        "+t3+"=p+2;\n");
        this.save("        "+t4+"=stack["+t3+"];\n");
        this.save("        if("+t4+"!=1) goto "+l1+";\n");
        this.save("        "+t5+"=heap["+t2+"];\n");
        this.save("        stack[p]="+t5+";\n");
        this.save("        goto "+l0+";\n");
        this.save("    "+l1+":\n");
        this.save("        "+t6+"=0;\n");
        this.save("        "+t7+"=heap["+t2+"];\n");
        this.save("        "+t8+"=0;\n");
        this.save("    "+l2+":\n");
        this.save("        if("+t8+">="+t7+") goto "+l3+";\n");
        this.save("        "+t9+"="+t8+"+"+t2+";\n");
        this.save("        "+t10+"=1+"+t9+";\n");
        this.save("        "+t11+"=heap["+t10+"];\n");
        this.save("        "+t12+"="+t4+"-1;\n");
        this.save("        "+ta+"=p+3;\n");        
        this.save("        stack["+ta+"]="+t1+";\n");
        this.save("        "+ta+"=p+4;\n");        
        ...
        this.save("        stack["+ta+"]="+t10+";\n");
        this.save("        "+ta+"=p+13;\n");        
        this.save("        stack["+ta+"]="+t11+";\n");
        this.save("        "+ta+"=p+14;\n");        
        this.save("        stack["+ta+"]="+t12+";\n");

        this.save("        "+t13+"=p+15;\n");
        this.save("        "+t14+"="+t13+"+1;\n");
        this.save("        stack["+t14+"]="+t11+";\n");
        this.save("        "+t15+"="+t13+"+2;\n");
        this.save("        stack["+t15+"]="+t12+";\n");
        this.save("        p=p+15;\n");
        this.save("        call getSize();\n");
        this.save("        "+t16+"=stack[p];\n");
        this.save("        p=p-15;\n");
        ...
        this.save("        "+t10+"=stack["+ta+"];\n");
        this.save("        "+ta+"=p+13;\n");
        this.save("        "+t11+"=stack["+ta+"];\n");
        this.save("        "+ta+"=p+14;\n");
        this.save("        "+t12+"=stack["+ta+"];\n");

        this.save("        "+t17+"="+t6+"+"+t16+";\n");
        this.save("        "+t6+"="+t17+";\n");
        this.save("        "+t8+"="+t8+"+1;\n");
        this.save("        goto "+l2+";\n");
        this.save("    "+l3+":\n");
        this.save("        stack[p]="+t6+";\n");
        this.save("    "+l0+":\n");
        this.save("}\n");
    }
    getInitArray()
    {
        ...
        var l7=valores.getEtiqueta();var l0=valores.getEtiqueta();
        this.save("void initArray(){\n");
        this.save("        stack[p]=h;\n");
        this.save("        "+t1+"=p+1;\n");
        this.save("        "+t2+"=stack["+t1+"];\n");
        this.save("        "+t1+"=p+2;\n");
        this.save("        "+t3+"=stack["+t1+"];\n");
        this.save("        "+t1+"=p+3;\n");
        this.save("        "+t4+"=stack["+t1+"];\n");
        this.save("        "+t1+"=p+4;\n");
        this.save("        "+t5+"=stack["+t1+"];\n");
        this.save("        "+t6+"="+t3+"+"+t2+";\n");
        this.save("        "+t7+"=heap["+t6+"];\n");
        this.save("        heap[h]="+t7+";\n");
        this.save("        h=h+1;\n");
        this.save("        if("+t4+"==1) goto "+l1+";\n");
        this.save("        "+t8+"=h;\n");
        ...
        this.save("        stack["+t13+"]="+t10+";\n");
        this.save("        "+t14+"="+t12+"+2;\n");
        this.save("        stack["+t14+"]="+t3+";\n");        
        this.save("        "+t15+"="+t12+"+3;\n");
        this.save("        stack["+t15+"]="+t11+";\n");
        this.save("        "+t16+"="+t12+"+4;\n");
        this.save("        stack["+t16+"]="+t5+";\n");
        this.save("        p=p+ 16;\n");
        this.save("        call initArray();\n");        
        this.save("        "+t17+"=stack[p];\n");
        this.save("        p=p- 16;\n");
        this.save("        "+ta+"=p+5;\n");
        this.save("        "+t1+"=stack["+ta+"];\n");
        this.save("        "+ta+"=p+6;\n");
